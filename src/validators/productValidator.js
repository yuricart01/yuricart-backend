...
const createProductSchema = z.object({
  ...
  primaryImageAlt: z.string().max(200).optional(),
  galleryAlts: z.union([z.string(), z.record(z.string())]).optional(),
  newGalleryAlts: z.union([z.array(z.string()), z.string()]).optional(),
